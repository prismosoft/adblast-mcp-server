 ...
 * Generated on: 2025-10-02T22:50:42.435Z
 */
...
const toolDefinitionMap: Map<string, McpToolDefinition> = new Map([
  ...
  ["updateProjectTitle", {
    ...
    inputSchema: {"type":"object","properties":{"project_id":{"type":"string","description":"The ID of the project."},"requestBody":{"type":"object","properties":{"title":{"type":"string","description":"The new project title."}},"required":["title"],"description":"The JSON request body."}},"required":["project_id","requestBody"]},
    method: "put",
    pathTemplate: "/api/projects/{project_id}",
    executionParameters: [{"name":"project_id","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["createVisual", {
    ...
    inputSchema: {"type":"object","properties":{"project_id":{"type":"string","description":"The ID of the project."},"sceneId":{"type":"string"},"requestBody":{"type":"object","properties":{"id":{"type":"string","description":"Visual unique valid uuid"},"number":{"type":"number","description":"Visual number inside this scene, starting from 1"},"duration_seconds":{"type":"number","description":"Playback duration in seconds (supports fractional values)"},"description":{"type":"string","description":"Visual short description"}},"required":["id","number","duration_seconds","description"],"description":"The JSON request body."}},"required":["project_id","sceneId","requestBody"]},
    method: "post",
    pathTemplate: "/api/projects/{project_id}/scenes/{sceneId}/visuals",
    executionParameters: [{"name":"project_id","in":"path"},{"name":"sceneId","in":"path"}],
    requestBodyContentType: "application/json",
